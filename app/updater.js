 ...
 */
updater.prototype.download = function(newManifest, cb, statusCallback){
  ...
  var timeout_wrapper = function( req ) {
    return function() {
      ...
      cb(new Error("File transfer timeout!"));
    };
  };
 ...
 */
updater.prototype.unpack = function(manifest, filename, cb){
